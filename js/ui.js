...
SW.ui = (function () {
  ...
  function renderDock(force) {
    ...
    else if (activeTab === 'tech') SW.uiTech.renderTech(body, force);
  ...
  function dispatch(e) {
    ...
    switch (act) {
      ...
      case 'openTechTree': SW.uiTech.showTechTreeRich(); return;
      case 'techSelect': SW.ui.techView.selected = btn.dataset.id; SW.uiTech.showTechTreeRich(); return;
      case 'techZoomIn': SW.uiTech.zoomTechView(1.18); SW.uiTech.showTechTreeRich(); return;
      case 'techZoomOut': SW.uiTech.zoomTechView(1 / 1.18); SW.uiTech.showTechTreeRich(); return;
      case 'techResetView': SW.ui.techView.x = 0; SW.ui.techView.y = 0; SW.ui.techView.zoom = 1; SW.uiTech.showTechTreeRich(); return;
